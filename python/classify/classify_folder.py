...
if __name__ == '__main__':
    trainFolder = "/database/ChengCheng/classify/CAS+cqbz+array/training"
    reszFolder = "/database/ChengCheng/classify/CAS+cqbz+array/resize"
    meanImgFolder = "/database/ChengCheng/classify/CAS+cqbz+array/resize"
    outFolder = "/database/ChengCheng/classify/CAS+cqbz+array/batches"


    testFolder = "/database/ChengCheng/classify/CAS+cqbz+array/test"
    startIdxTest = 8000

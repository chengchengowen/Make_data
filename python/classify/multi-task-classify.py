...
if __name__ == '__main__':
    trainFolder = "/database/attendance/training"
    reszFolder = "/database/attendance/resize"
    meanImgFolder = "/database/attendance/resize"
    outFolder = "/database/attendance/batches"
    testFolder = "/database/attendance/test"
    startIdxTest = 8000
